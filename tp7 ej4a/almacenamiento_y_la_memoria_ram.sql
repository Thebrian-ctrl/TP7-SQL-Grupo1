...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-09-2025 a las 02:41:49
...
--
-- Base de datos: `almacenamiento y la memoria_ram`
--
CREATE DATABASE IF NOT EXISTS `almacenamiento y la memoria_ram` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `almacenamiento y la memoria_ram`;
